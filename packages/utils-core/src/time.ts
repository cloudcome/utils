 ...
 */
export function timeInDay(timeMs: number) {
 ...
 */
export function timeInHour(timeMs: number) {
 ...
 */
export function timeInMinute(timeMs: number) {
 ...
 */
export function timeInSecond(timeMs: number) {
