...
type UniCloudObjectServer<I extends AnyArray, T> = (...inputs: I) => Promise<UniCloudObjectOutput<T>>;
...
export function createUseCloudObject(objectName: ImportObjectArgs[0], options?: CreateUseCloudObjectOptions) {
  ...
  return function useCloudObject<I extends AnyArray, O>(
    caller: (server: UniCloudObjectServer<I, O>, ...inputs: I) => Promise<UniCloudObjectOutput<O>>,
